...
namespace Rotorz.Games.Reflection
{
    ...
    public sealed class ClassTypeReferencePropertyDrawer : PropertyDrawer
    {
        ...
        private static string DrawTypeSelectionControl(Rect position, GUIContent label, string classRef,
        ...
        private static void DrawTypeSelectionControl(Rect position, SerializedProperty property, GUIContent label,
            ClassTypeConstraintAttribute filter)
        {
            try
            {
